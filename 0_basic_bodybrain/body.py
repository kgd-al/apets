    ...
    while not to_explore.empty():
        ...
        for attachment_point_tuple in module.module_reference.attachment_points.items():
            if part_count < max_parts:
                child = __add_child(cppn, module, attachment_point_tuple, grid)
...
def __add_child(
    ...
    child_type, angle = __evaluate_cppn(cppn, new_pos, chain_length)
